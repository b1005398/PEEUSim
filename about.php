...
<html>
<head>
<title>PEEU Day In The Life Simulator | About</title>
...
<div id="background">
  <div id="page">
    <div class="header">
      <div class="footer">
        <div class="body">
          <div id="sidebar"> <a href="index.php"><img id="logo" src="images/logo.jpg" with="157" height="84" alt="" title=""/></a>
            ...
            <div class="content">
              <ul>
                <li>
                  ...
                  <p> Our website templates are created with inspiration, checked for quality and originality and meticulously sliced and coded. What’s more, they’re absolutely free! You can do a lot with them. You can modify them. You can use them to design websites for clients, so long as you agree with the <a href="about.html">Terms of Use</a>. You can even remove all our links if you want to. </p>
                </li>
                <li>
                ...
                <li>
                  ...
                  <p> <span>Version 2<span> Website Template details, discussion and updates for this <a href="http://www.freewebsitetemplates.com/forum/f18/minimalistic-web-template-18755">Minimalistic Web Template</a>.
                    Website Template design by <a href="http://www.freewebsitetemplates.com/">Free Website Templates.</a> Please feel free to remove some or all the text and links of this page and replace it with your own About content. </p>
                </li>
              </ul>
            </div>
          </div>
